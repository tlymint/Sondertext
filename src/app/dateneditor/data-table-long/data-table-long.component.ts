...
@Component({
  selector: 'app-data-table-long',
  templateUrl: './data-table-long.component.html',
  styleUrls: ['./data-table-long.component.scss']
})
export class DataTableLongComponent implements AfterViewInit, OnInit {
  ...
  openDialog() {
    this.dialog.open(DialogTableLongComponent);
  }

}

@Component({
  selector: 'dialog-table-long',
  templateUrl: 'dialog-table-long.html'
})
export class DialogTableLongComponent {}
